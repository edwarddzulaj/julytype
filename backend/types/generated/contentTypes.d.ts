...
export interface ApiSettingSetting extends Schema.SingleType {
  ...
  attributes: {
    websiteDetails: Attribute.Component<"settings.website-title">;
    footerContent: Attribute.Component<"settings.footer-details">;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiSimplePageSimplePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::simple-page.simple-page", "oneToOne", "admin::user"> &
      Attribute.Private;
    updatedBy: Attribute.Relation<"api::simple-page.simple-page", "oneToOne", "admin::user"> &
      Attribute.Private;
  };
}
...
export interface ApiStyleStyle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    weights: Attribute.Component<"typeface.weight", true>;
    slug: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::style.style", "oneToOne", "admin::user"> &
      Attribute.Private;
    updatedBy: Attribute.Relation<"api::style.style", "oneToOne", "admin::user"> &
      Attribute.Private;
  };
}

export interface ApiTypefaceTypeface extends Schema.CollectionType {
  ...
  attributes: {
    ...
    wholePackageDiscount: Attribute.Integer &
      Attribute.SetMinMax<{
        min: 0;
        max: 100;
      }>;
    trialFonts: Attribute.Media;
    styles: Attribute.Relation<"api::typeface.typeface", "oneToMany", "api::style.style">;
    slug: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::typeface.typeface", "oneToOne", "admin::user"> &
      Attribute.Private;
    updatedBy: Attribute.Relation<"api::typeface.typeface", "oneToOne", "admin::user"> &
      Attribute.Private;
  };
}
...
declare module "@strapi/strapi" {
  export module Shared {
    export interface ContentTypes {
      ...
      "api::typeface.typeface": ApiTypefaceTypeface;
    }
  }
}
